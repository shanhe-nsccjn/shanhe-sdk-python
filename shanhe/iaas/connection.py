...
from shanhe.iaas.actions.instance import InstanceAction
from shanhe.iaas.actions.instance_groups import InstanceGroupsAction
from shanhe.iaas.actions.volume import VolumeAction
from shanhe.iaas.actions.eip import EipAction
from shanhe.iaas.actions.router import RouterAction
from shanhe.iaas.actions.vxnet import VxnetAction
from shanhe.iaas.actions.keypair import KeypairAction
from shanhe.iaas.actions.image import ImageAction
from shanhe.iaas.actions.loadbalancer import LoadBalancerAction
from shanhe.iaas.actions.security_group import SecurityGroupAction
from shanhe.iaas.actions.snapshot import SnapshotAction
from shanhe.iaas.actions.tag import TagAction
from shanhe.iaas.actions.alarm_policy import AlarmPolicy
from shanhe.iaas.actions.cluster import ClusterAction
from shanhe.iaas.actions.nic import NicAction
from shanhe.iaas.actions.s2 import S2Action
from shanhe.iaas.actions.sdwan import SdwanAction
from shanhe.iaas.actions.migrate import MigrateAction
from shanhe.iaas.actions.vpc_border import VpcBorder

from shanhe.conn.auth import QuerySignatureAuthHandler
from shanhe.conn.connection import HttpConnection, HTTPRequest
from shanhe.misc.json_tool import json_load, json_dump
from shanhe.misc.utils import filter_out_none
...
class APIConnection(HttpConnection):
    ...
    def create_rdb(self, vxnet=None,
        ...
        @param rdb_type: defined by shanhe: 1, 2, 3, 4, 5
    ...
    def resize_mongos(self, mongos,
        ...
        @param mongo_type: defined by shanhe: 1, 2, 3, 4.
                           see: https://docsv3.shanhe.com/api/mongo/resize_mongos.html
        @param cpu: cpu core number.
        @param memory: memory size in MB.
        """
    ...
    def resize_caches(self, caches,
        ...
        @param cache_size: defined by shanhe: 1 - 32 GB.
        @param cpu: cpu core number.
        @param memory: memory size in MB.
        """
    ...
    def add_group_role_rules(self,
        ...
        @param policy: the policy whose format is 'resource_typeor.operation_type'.
                        See: https://docsv3.shanhe.com/api/resource_acl/AddGroupRoleRules.html
